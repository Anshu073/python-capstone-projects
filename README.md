...
A collection of beginner-to-intermediate Python projects built while learning core programming concepts — functions, loops, conditionals, OOP, error handling, and file handling.

Each project lives in its own folder with its own code.
...
|---------|-------------|----------------|
| [Hangman Game](./hangman-game) | Classic word-guessing game with limited attempts | Random module, loops, strings |
| [Rock Paper Scissors](./rock-paper-scissors) | Classic game vs computer | Random, conditionals |
| [Quiz Game](./quiz-game) | Multiple-choice quiz with score tracking | Lists, dictionaries, loops |
| [Number Guessing Game](./number-guessing-game) | Guess the randomly generated number | Random module, loops |
| [Slot Machine](./slot-machine) | Simulates a casino-style slot machine game | Random module, loops |
| [Dice Roller](./dice-roller) | Simulates rolling a dice | Random module |
...
| Project | Description | Concepts Used |
|---------|-------------|----------------|
| [Digital Clock](./digital-clock) | Real-time digital clock with GUI | PyQt5, time module, OOP |
...
These projects were built as part of learning Python through hands-on practice, focusing on writing clean, functional, and readable code.
